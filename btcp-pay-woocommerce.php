...
function btcp_woocommerce_settings() {
 ?>
   ...
   <p>Please paste the <strong>btcpWidget.data</strong> section from your widget code from your account on the <a href="https://btcppay.com" target="_blank">btcppay.com</a> site into the box below (as per the example below) and we'll take care of it working within WooCommerce.</p>
...
?>
            <div id="custom_input">
              ...
              <script id="btcp_widget_data">
                ...
                $btcp_widget_data = str_replace("Data:\n\n", "Data:\\n\\n", str_replace("\r","",get_option('btcp_woocommerce_widget_code')));
                $btcp_widget_data = explode("\n",$btcp_widget_data);
                for($i=0; $i<count($btcp_widget_data); $i++) {
